...
int CLM::loadModel(const char *filename, Model& pModel)
{
...
int CLM::readVecFromString(const char *str, float *f, int count)
{
	auto ptr = str;
	int i;
...
int CLM::readMatFromString(const char *str, CvMat *Mat)
{
	auto ptr = str;
	int i;
	float *pdat;
